...
class TestMarketSimulation(WithSQLAlchemyActiveRecordStrategies, WithQuantdslApplication):
    ...
    def test_register_market_simulation(self):
        ...
        assert market_calibration.id in self.app.market_calibration_repo
        assert self.app.market_calibration_repo[market_calibration.id]
