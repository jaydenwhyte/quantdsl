...
from quantdsl.domain.model.call_dependencies import register_call_dependencies, call_dependencies_id_from_call_id
from quantdsl.domain.model.call_dependents import register_call_dependents, call_dependents_id_from_call_id
from quantdsl.domain.model.call_leafs import register_call_leafs
from quantdsl.domain.model.call_link import register_call_link, call_link_id_from_call_id
...
def generate_dependency_graph(contract_specification, call_dependencies_repo, call_dependents_repo, call_leafs_repo,
    ...
    for stub in generate_stubbed_calls(contract_specification.id, dsl_module, dsl_expr, dsl_globals, dsl_locals):
        ...
        # Register the stub requirements as call dependencies.
    ...
    link_id = call_link_id_from_call_id(contract_specification.id)
    for call_id in generate_execution_order(leaf_ids, call_dependents_repo, call_dependencies_repo):
        ...
        link_id = call_link_id_from_call_id(call_id)
...
def generate_execution_order(leaf_call_ids, call_dependents_repo, call_dependencies_repo):
    ...
    while S:
        ...
        try:
            dependents = call_dependents_repo[call_dependents_id_from_call_id(n)]
        except KeyError:
            continue
        ...
        for m in dependents:
            ...
            for d in call_dependencies_repo[call_dependencies_id_from_call_id(m)]:
