...
def evaluate_call_and_queue_next_calls(contract_valuation_id, dependency_graph_id, call_id, call_evaluation_queue,
                                       ...
                                       compute_pool=None, result_counters=None, usage_counters=None):
