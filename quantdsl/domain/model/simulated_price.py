...
def make_simulated_price_id(simulation_id, commodity_name, fixing_date, delivery_date):
    ...
    return uuid.uuid5(NAMESPACE_SIMULATED_PRICE_ID, price_id)
...
NAMESPACE_SIMULATED_PRICE_ID = UUID('c37b276d-f440-4960-8853-6ba084b22749')
